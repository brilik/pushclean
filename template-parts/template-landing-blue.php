        ...
        <div class="main-block">
            <div class="main-block-content">
                <div class="main-block__img">
                    <div class="wrapper">
                        <img src="<?= get_template_directory_uri(); ?>/assets/img/main-img-makeup.png">
                    </div>
                </div>
                    ...
                    <div class="wrapper">
                        <div class="main-block__info-content">
                            ...
                            <div class="main-block__info-img">
                                <img data-src="<?= get_template_directory_uri(); ?>/assets/img/main-info-img-makeup.png"
                        ...
                        <div class="main-block-form">
                            <form class="js--contact-form">
                                ...
                                <div class="form-info">
                                    <img data-src="<?= get_template_directory_uri(); ?>/assets/img/form-img-makeup.png"
                                         src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="" class="js-img">
                                ...
                                <img data-src="<?= get_template_directory_uri(); ?>/assets/img/form-img2.png" data-srcset="<?= get_template_directory_uri(); ?>/assets/img/form-img2.png 1x, <?= get_template_directory_uri(); ?>/assets/img/form-img2-2x.png 2x" srcset="/" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="" class="js-img">
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="safe-content">
                    <div class="safe-row">
                        ...
                        <div class="safe-column">
                            <div class="safe-img">
                                <img data-src="<?= get_template_directory_uri(); ?>/assets/img/safe-img1-makeup.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt=""
                                     class="js-img">
                            </div>
        ...
        <section class="whats">
            <div class="wrapper">
                ...
                <div class="whats-content">
                    <div class="whats-img">
                        <img data-src="<?= get_template_directory_uri(); ?>/assets/img/whats-img-makeup.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="" class="js-img">
                    </div>
                    <div class="whats-item">
                        <div class="whats-item__img">
                            <img data-src="<?= get_template_directory_uri(); ?>/assets/img/icons/whats-icon1-makeup.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="" class="js-img">
                        </div>
                    ...
                    <div class="whats-item">
                        <div class="whats-item__img">
                            <img data-src="<?= get_template_directory_uri(); ?>/assets/img/icons/whats-icon2-makeup.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt=""
                                 class="js-img">
                        </div>
                        <div class="whats-item__info">
                    ...
                    <div class="whats-item">
                        <div class="whats-item__img">
                            <img data-src="<?= get_template_directory_uri(); ?>/assets/img/icons/whats-icon3-makeup.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt=""
                                 class="js-img">
                        </div>
                        <div class="whats-item__info">
                            <span>Contains:</span>
        ...
        <div class="offer">
            <div class="wrapper">
                <div class="offer-content">
                    <div class="offer-img">
                        <img data-src="<?= get_template_directory_uri(); ?>/assets/img/offer-img-makeup.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACw="
                             alt="" class="js-img">
                    </div>
